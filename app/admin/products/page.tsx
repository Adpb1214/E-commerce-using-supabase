...
const AdminPanel = () => {
  ...
  const [categoryInventory, setCategoryInventory] = useState<Record<string, number>>({})
  ...
  const topSellingProducts = [...products].sort((a, b) => (b.sales_count || 0) - (a.sales_count || 0)).slice(0, 5)
  ...
  const filteredProducts =
    filter === "low_stock" ? lowStockProducts : filter === "top_selling" ? topSellingProducts : products
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Across {Object.keys(categorySales).length} categories</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Items with stock below 15</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {products.reduce((sum, product) => sum + (product.sales_count || 0), 0)}
                </div>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex justify-between items-center">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Sales: {product.sales_count || 0}</p>
                        </div>
