    ...
    <div className="md:col-span-2 flex flex-col">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 flex-grow">
        {products.slice(0, 10).map((product) => (
          <Link href={`/${product.id}`} key={product.id} className="group">
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow h-full">
              ...
              <div className="p-4">
                ...
                <p className="text-primary font-bold mt-1">
                <span style={{color:"red"}}>Category:</span>  {product?.category}
                </p>
              </div>
            </div>
          </Link>
    ...
    <div className="flex flex-col gap-4 md:col-span-1 h-full">
      <div className="flex flex-col flex-grow gap-4">
        ...
        <div className="flex-grow bg-red-500 rounded-lg overflow-hidden shadow-lg">
          <img
            src="https://img.freepik.com/premium-vector/autumn-offer-vertical-banner-design-with-shop-now-button-text-block-template-fall-season-shopping-promotion-vector-illustration_71301-937.jpg" // Replace with actual banner image
            alt="Big Sale"
